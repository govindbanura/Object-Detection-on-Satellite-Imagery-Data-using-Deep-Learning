...
#Here I created a list of 4 entries that contains the real coordinates
                        ...
                        confidence.append(round(100*new_probs[jk]))
                        
                        cv2.rectangle(img,(real_x1, real_y1), (real_x2, real_y2), (int(class_to_color[key][0]), int(class_to_color[key][1]), int(class_to_color[key][2])),2)

                        textLabel = '{}: {}'.format(key,round(100*new_probs[jk]))
...
#                         cv2.rectangle(img, (textOrg[0] - 5,textOrg[1]+baseLine - 5), (textOrg[0]+retval[0] + 5, textOrg[1]-retval[1] - 5), (255, 255, 255), -1)
                        cv2.putText(img, textLabel, textOrg, cv2.FONT_HERSHEY_DUPLEX, fontScale = 0.75, color = (0, 0, 0), thickness = 1)
...
df = pandas.DataFrame(data={"img_name": img_name_list, "x1": x1_list, "y1": y1_list, "x2": x2_list, "y2": y2_list, "confidence":  confidence})
